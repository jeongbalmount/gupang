...
public class ItemRepositoryTest {
    ...
    void itemRepositoryTest() {
        ...
        Item item = new Item("name",10, 100, seller1, category1);
        Item item2 = new Item("name",10, 100, seller1, category1);
        Item item3 = new Item("name",10, 100, seller2, category2);
        Item item4 = new Item("name",10, 100, seller2, category2);
